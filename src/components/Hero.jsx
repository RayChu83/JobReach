...
export default function Hero() {
  return (
    <section className="flex items-center justify-between max-w-[1280px] m-auto flex-wrap">
      <div className="p-4 flex flex-col gap-y-4 drop-shadow-[0_0_125px_rgba(27,190,23,.65)]">
        ...
        <Button variant="cta" asChild className="w-fit">
          <Link href="/contact">View Jobs</Link>
        </Button>
      </div>
      <div>
